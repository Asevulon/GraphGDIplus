...
// GraphGDIplus.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CGraphGDIplusApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CGraphGDIplusApp

CGraphGDIplusApp::CGraphGDIplusApp()
{
...
// Единственный объект CGraphGDIplusApp

CGraphGDIplusApp theApp;


// Инициализация CGraphGDIplusApp

BOOL CGraphGDIplusApp::InitInstance()
{
